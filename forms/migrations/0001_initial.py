    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('email', models.EmailField(max_length=254, unique=True, validators=[django.core.validators.RegexValidator(message='Only sophomores with college email addresses are authorised.', regex='^[2][1][a-z]{3}\\d{3}@[nith.ac.in]*')])),
